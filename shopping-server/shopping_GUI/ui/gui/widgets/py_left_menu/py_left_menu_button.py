...
class PyLeftMenuButton(QPushButton):
    ...
    def paintEvent(self, event):
        ...
        if self._is_active:
            ...
            folder_path = "PyOneDark_Qt_Widgets_Modern_GUI"
            # Get the path of the specific folder by joining the current working directory with the folder name
            app_path = os.path.abspath(os.path.join(os.getcwd(), folder_path))
